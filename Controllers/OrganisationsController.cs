...
namespace Avengers.Controllers
{
    public class OrganisationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrganisationID,Denomination,Adresse,PaysID,Date_de_creation")] Organisation organisation)
        {
            ...
            ViewBag.PaysID = new SelectList(db.Pays, "PaysID", "Pays_nom", organisation.PaysID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrganisationID,Denomination,Adresse,PaysID,Date_de_creation")] Organisation organisation)
        {
            if (ModelState.IsValid)
            {
